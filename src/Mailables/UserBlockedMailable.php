...
namespace Yormy\ChaskiLaravel\Mailables;
...
use Yormy\ChaskiLaravel\DataObjects\Config\NotificationMailConfig;
use Yormy\ChaskiLaravel\DataObjects\Config\NotificationSlackConfig;
